...
3. **External Research**: Search the web for the company's public information — financials, strategic initiatives, org structure, technology stack, executive leadership, and industry context.
...
Generate the following sections in order. Use markdown formatting. Use **bold** for key data points, company names, and Docusign product names. Use *italic* for emphasis on specific terms.
